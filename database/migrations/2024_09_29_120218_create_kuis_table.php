...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('kuis', function (Blueprint $table) {
            ...
            $table->string('q1');  // Status pekerjaan
            $table->string('q2');  // Sumber dana
            ...
            $table->string('q7');  // 7. Berapa perusahaan/instansi/institusi yang sudah Anda lamar
            $table->string('q8'); // 8. Berapa banyak perusahaan/instansi/institusi yang merespons lamaran anda ?
            $table->string('q9'); // 9. Berapa banyak perusahaan/instansi/institusi yang mengundang anda untuk wawancara ?
            $table->string('q10'); // 10. Apakah Anda aktif mencari pekerjaan dalam 4 minggu terakhir ?
